   ...
   return (
      <div className='content-feature-review p-3'>
         <div className='flex justify-between items-center p-3'>
            <h2 className=' text-black dark:text-white  text-xl font-medium'>Featured Review</h2>
            ...
            {movieTopRated.map((movie: ResultTopRated) => (
               <div key={movie.id} className='feature-review-card py-3 px-5'>
                  <div className='img-feature-review relative'>
                     <img src={`https://image.tmdb.org/t/p/original${movie.backdrop_path}`} alt='Image Poster' />
                     <div
...
export default SliderFeatureReviews;
