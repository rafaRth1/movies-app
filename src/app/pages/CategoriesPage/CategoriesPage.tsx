				...
				<div className='content-categories'>
					{arrayAllCategories.map((categories) => (
						<div
							...
							className='card-categories text-black dark:text-white p-2'>
							...
							<div className='px-2 flex-1'>
								<h5 className='text-black dark:text-white font-medium text-lg hover:text-indigo-700 dark:hover:text-indigo-700 cursor-pointer'>
